...
export default function DashComments() {
    ...
    const fetchComments = async () => {
      try {
        const res = await fetch(
          `https://blogger-backend-tzyw.onrender.com/comments/getcomments`,
          {
            method: "GET",
            headers:{
  ...
  const handleShowMore = async () => {
    ...
    try {
      const { data, status } = await axios.get(
        `https://blogger-backend-tzyw.onrender.com/comments/getcomments?startIndex=${startIndex}`
      );
  ...
  const handleDeleteComment = async () => {
    ...
    try {
      const res= await fetch(
        `https://blogger-backend-tzyw.onrender.com/comments/deletecomment/${commentIdToDelete}`,{
          method:"DELETE",
          headers:{
